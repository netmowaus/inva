...
<body>
    <div class="container">
        <h1>Edit Client: {{ $client->company_name }}</h1>
        ...
        <form action="{{ route('admin.clients.update', $client) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="contact_name" name="contact_name" value="{{ old('contact_name', $client->contact_name) }}" required>
            </div>

            <div class="form-group">
                <label for="contact_email">Contact Email:</label>
                <input type="email" id="contact_email" name="contact_email" value="{{ old('contact_email', $client->contact_email) }}" required>
            </div>
