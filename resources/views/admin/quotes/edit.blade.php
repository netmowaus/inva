    ...
    <div class="container">
        ...
        <form action="{{ route('admin.quotes.update', $quote) }}" method="POST" id="quoteForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="quote_number" name="quote_number" value="{{ old('quote_number', $quote->quote_number) }}" required>
            </div>

            <div class="form-group">
                <label for="quote_date">Quote Date:</label>
                <input type="date" id="quote_date" name="quote_date" value="{{ old('quote_date', $quote->quote_date->format('Y-m-d')) }}" required>
            </div>

            <div class="form-group">
                <label for="expiry_date">Expiry Date:</label>
                <input type="date" id="expiry_date" name="expiry_date" value="{{ old('expiry_date', $quote->expiry_date->format('Y-m-d')) }}" required>
            </div>
            ...
            <div class="item-list">
                <table id="quoteItemsTable">
                    ...
                    <tbody>
                        @php $items = old('items', $quote->items->toArray()); @endphp
                        @if(is_array($items))
                ...
                <p><small><strong>Note:</strong> JavaScript is used for adding/removing items and live total calculations. Ensure all fields are correct before submitting.</small></p>
            </div>
            ...
            <a href="{{ route('admin.quotes.show', $quote) }}" class="btn-cancel">Cancel</a>
        </form>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addItemBtn.addEventListener('click', function () {
            ...
            itemIndex++; // Increment index for next new item
        ...
        // Attach listeners to initially loaded rows
        itemsTableBody.querySelectorAll('.item-row').forEach(row => {
